#ifndef ORDINARY_CITIZEN_COMMAND_DOT_H
#define ORDINARY_CITIZEN_COMMAND_DOT_H
...
class OrdinaryCitizenCommand : public BaseComputationCommand
{
public:
    bool Execute(ComputationContext &ctx) override
    {
        ...
        try
        {
            td = std::any_cast<TaxableEntity *>(ctx.Get("tax_cargo")); // Attempt to cast to int
        }
    ...
    {
        return std::make_shared<OrdinaryCitizenCommand>(*this);
    }
};
#endif